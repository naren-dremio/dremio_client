...
DESCRIPTOR = _descriptor.FileDescriptor(name='command.proto', package='com.dremio.proto.flight.commands', syntax='proto2', serialized_options=_b('\n com.dremio.proto.flight.commandsH\001'), serialized_pb=_b(
...
_COMMAND = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='query',
            full_name='com.dremio.proto.flight.commands.Command.query',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='parallel',
            full_name='com.dremio.proto.flight.commands.Command.parallel',
            index=1,
            number=2,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='coalesce',
            full_name='com.dremio.proto.flight.commands.Command.coalesce',
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='ticket',
            full_name='com.dremio.proto.flight.commands.Command.ticket',
            index=3,
            number=4,
            type=12,
            cpp_type=9,
